      ...
      <div class="max-w-4xl mx-auto relative z-10">
        ...
        <div class="text-center">
          ...
          <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button type="button" id="footer-book-a-call"
               class="inline-flex items-center gap-3 px-8 py-4 bg-primary text-white font-bold rounded-full shadow-lg hover:shadow-xl hover:bg-primary-light transition-all duration-300 text-lg cursor-pointer">
